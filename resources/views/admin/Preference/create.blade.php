...
@section('content_header')
    <h1 class="p-4 shadow-lg rounded-pill bg-white text-center">Preferences</h1>
@stop
...
<section class="card">
  ...
  <article class="card-body">
    ...
    <form method="POST" action="{{ route('admin.preference.store') }}" novalidate>
        @csrf
        <div class="mb-3">
            <x-jet-label value="Nombre de preferencia" />
